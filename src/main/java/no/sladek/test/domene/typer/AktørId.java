package no.sladek.test.domene.typer;
...
public class AktørId implements Serializable, Comparable<AktørId> {
    ...
    @JsonValue
    @jakarta.validation.constraints.Pattern(regexp = VALID_REGEXP, flags = {jakarta.validation.constraints.Pattern.Flag.CASE_INSENSITIVE})
